...
[map dimensions] = compute_map([], [], siftMapParam, siftData);

siftData = struct('map', map, 'clusters', clusters, 'superpixels', sp);
[f, sp2reg] = compute_ss_features([], [], siftBOWParam, siftData);
...
[f, sp2reg] = compute_ss_features([], [], gTextonBOWParam, gTextonData);
