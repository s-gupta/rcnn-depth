function masked_window = ...
    rcnn_im_crop_region(im, bbox, mask, crop_mode, crop_size, padding, image_mean)
% window = rcnn_im_crop(im, bbox, mask, crop_mode, crop_size, padding, image_mean)
